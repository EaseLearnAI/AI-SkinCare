...
import 'dart:math' as math; // 导入math包来使用sin函数
...
// 可爱风格成分分析弹窗组件
class CuteIngredientAnalysisDialog extends StatefulWidget {
  ...
  const CuteIngredientAnalysisDialog({
    Key? key,
  ...
  @override
  _CuteIngredientAnalysisDialogState createState() =>
      _CuteIngredientAnalysisDialogState();
}

class _CuteIngredientAnalysisDialogState
    extends State<CuteIngredientAnalysisDialog>
    with SingleTickerProviderStateMixin {
  late AnimationController _animationController;
...
// 显示成分分析弹窗的辅助函数
void showCuteIngredientAnalysisDialog(
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return CuteIngredientAnalysisDialog(
